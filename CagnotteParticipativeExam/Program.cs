...
// Configuration CORS pour permettre l'accès depuis Blazor WebAssembly
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowBlazorClient", policy =>
    {
        policy.WithOrigins(
                "https://localhost:7144",  // Port HTTPS du frontend Blazor
                "http://localhost:5207",   // Port HTTP du frontend Blazor
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Cagnotte API v1");
